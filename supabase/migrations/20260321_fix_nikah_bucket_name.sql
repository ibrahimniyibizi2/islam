-- Fix nikah bucket name from nikah_documents to nikah-documents
-- First, drop the old bucket if it exists
DELETE FROM storage.buckets WHERE id = 'nikah_documents';
