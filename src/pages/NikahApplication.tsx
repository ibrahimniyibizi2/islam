        ...
        <div className="container mx-auto max-w-md text-center">
          <div className="mb-6">
            ...
            <p className="text-gray-600 mb-6">
              Your Nikah application has been successfully submitted. You will receive a confirmation email shortly.
            </p>
            <Link to="/">
        ...
        <Card className="mb-6 border-pink-200">
          <CardHeader className="bg-pink-50">
            <div className="flex items-center gap-4">
              ...
              <div>
                <CardTitle className="text-2xl text-gray-900">Nikah Application</CardTitle>
                <CardDescription className="text-gray-600">
                  Apply for Islamic marriage ceremony and registration
                </CardDescription>
              </div>
            </div>
          </CardHeader>
          <CardContent className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-gray-600">50,000 - 200,000 RWF</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                <p className="font-semibold text-gray-900 mb-1">Provided by</p>
                <p className="text-gray-600">Supreme Council of Islamic Affairs</p>
              </div>
            </div>
          </CardContent>
        </Card>
...
export default NikahApplicationPage;
